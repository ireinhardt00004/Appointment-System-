  ...
  <div class="px-3 py-3 lg:px-5 lg:pl-3">
    <div class="flex items-center justify-between">
      ...
      <div class="flex justify-end items-center space-x-4 place-self-end">
         ...
         <div id="NavClock" class="flex cursor-pointer border-2 border-slate-400 text-slate-700 p-2 space-x-1 text-lg rounded-lg dark:text-white">
            <p>AM</p>
         </div>
...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
   <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
      ...
      <li class="{{ Route::is('dashboard') ? 'active  !border-l-4 !border-green-500' : '' }}">
          ...
          <li class="{{ Route::is('monitor.index') ? 'active  !border-l-4 !border-green-500' : '' }}">
            <a href="{{ route('monitor.index') }}" class="{{ Route::is('monitor.index') ? 'active !text-green-500 !font-semibold' : '' }} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               <svg class="{{ Route::is('monitor.index') ? 'active text-green-500 font-extrabold' : '' }} w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                  <path d="M16.975 11H10V4.025a1 1 0 0 0-1.066-.998 8.5 8.5 0 1 0 9.039 9.039.999.999 0 0 0-1-1.066h.002Z"/>
                  <path d="M12.5 0c-.157 0-.311.01-.565.027A1 1 0 0 0 11 1.02V10h8.975a1 1 0 0 0 1-.935c.013-.188.028-.374.028-.565A8.51 8.51 0 0 0 12.5 0Z"/>
               </svg> 
               <svg class="{{ Route::is('monitor.index') ? 'active text-green-500 font-extrabold' : '' }} flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
               ...
               <span class="ms-3">Appointment Form</span>
            </a>
         </li> 
         <!-- <li class="{{ Route::is('form.one') ? 'active  !border-l-4 !border-green-500' : '' }}">
            ...
            <svg class="{{ Route::is('form.one') ? 'active text-green-500 font-extrabold' : '' }} flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
               ...
               <svg class="{{ Route::is('form.one') ? 'active text-green-500 font-extrabold' : '' }} flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Noaa.33-B AFA</span>
...
<script>
  ...
  const Tunog = window.speechSynthesis
   ...
   const NavOrasan = ()=>{
       ...
       NavClock.children[0].innerHTML = pitsa.toLocaleTimeString()
