...
<head>
    ...
    <title><?php echo e($title ?? 'Loading.....'); ?></title>
    <style>
        #preloaderz {
            position: absolute;
            top: 0;
        ...
        .fill-load {
            background: rgb(255,23,2);
            background: linear-gradient(90deg, rgba(255,23,2,1) 0%, rgba(235,246,35,1) 51%, rgba(0,39,255,1) 100%);
            height: 100%;
            width: 0;
            position: absolute;
            top: 0;
...
<body id="bodyWithPreloader"> <!-- Add ID to body tag -->
    <div id="preloaderz">
        <div id="loaderz">
            <img class="load-image" src="<?php echo e(asset('assets/images/DepEd-Logo.png')); ?>" alt="loading">
...
<?php /**PATH C:\Project\A A FOR DEBUGGING AND TEST\app-depedsys\resources\views/preloader.blade.php ENDPATH**/ ?>