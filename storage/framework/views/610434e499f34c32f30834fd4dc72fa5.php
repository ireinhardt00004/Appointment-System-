...
<div class="py-10 px-5 mx-auto flex flex-col justify-center items-center  w-[100%] shadow-[0px_0px_17px_-1px_rgba(120,120,120,1)] border border-gray-300  space-y-2">
   <a href="<?php echo e(route('appointment.index')); ?>" title="Click to refresh page"> <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Appointment Data Entry  </h2></a>
...
[$__name, $__params] = $__split('search-appointments');

$__html = app('livewire')->mount($__name, $__params, 'lw-3543564745-0', $__slots ?? [], get_defined_vars());
...
<!-- <section class="bg-white w-full h-full dark:bg-gray-900">
  <div class="py-10 px-5 mx-auto  w-[100%] shadow-[0px_0px_17px_-1px_rgba(120,120,120,1)] border border-gray-300 rounded-[16px]"> -->
      ...
      <form  class="mx-auto w-full" method="POST" action="<?php echo e(route('submit.appointment')); ?>">
      <?php echo csrf_field(); ?>
      <!-- Group -->
                    ...
                    <table class="text-sm text-center text-gray-500 dark:text-gray-400 w-full">
                        ...
                        <tbody>
                            <?php
                                $startIndex = 1;
                            ?>
                            <?php if(isset($trasheds)): ?>
                            <?php if($trasheds->isEmpty()): ?>
                            <tr>
                                <br>
                            <td colspan="9"class="px-6 py-4 font-bold">Trash is empty.</td>
                             ...
                             <?php else: ?>
                                ...
                                ?>
                                <?php $__currentLoopData = $trasheds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $trash): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                        <td class="px-6 py-4"><?php echo e($startIndex + $index); ?></td>
                                        <td class="px-6 py-4"><?php echo e($trash->transaction_number); ?></td>
                                            <td class="px-6 py-4"><?php echo e($trash->fname); ?> <?php echo e($trash->mname); ?>  <?php echo e($trash->lname); ?>  <?php echo e($trash->extname); ?></td>
                                            <td class="px-6 py-4"><?php echo e($trash->school_district); ?></td>
                                            <td class="px-6 py-4"><?php echo e($trash->salary_grade); ?> - <?php echo e($trash->salary_increment); ?></td>
                                            <td class="px-6 py-4"><?php echo e($trash->appointment_nature); ?></td>
                                            <td class="px-6 py-4"><?php echo e($trash->appointment_status); ?></td>
                                            <td class="px-6 py-4"><?php echo e($trash->date_original_appointment); ?></td>
                                            <td class="px-6 py-4"><?php echo e($trash->eligibility); ?></td>
                                            <td class="px-6 py-4"><?php echo e($trash->users->fname); ?> <?php echo e($trash->users->middlename); ?> <?php echo e($trash->users->lname); ?></td>
                                        <td class="px-6 py-4"><?php echo e(\Carbon\Carbon::parse($trash->deleted_at)->format('F d, Y H:i:s')); ?> (<?php echo e(\Carbon\Carbon::parse($trash->deleted_at)->diffForHumans()); ?>)</td>
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <form action="<?php echo e(route('appointment.restore')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <form action="<?php echo e(route('appointment.delete-permanently')); ?>" method="POST" id="delete-TrashForm">
                    <?php echo csrf_field(); ?>
...
<?php $__env->startSection('title','Appointment Data Entry'); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Project\A A FOR DEBUGGING AND TEST\app-depedsys\resources\views/forms/appointment.blade.php ENDPATH**/ ?>