...
<!-- <section class="bg-white w-full h-full dark:bg-gray-900">
  <div class="py-10 px-5 mx-auto  w-[100%] shadow-[0px_0px_17px_-1px_rgba(120,120,120,1)] border border-gray-300 rounded-[16px]"> -->
      ...
      <form  class="mx-auto w-full " id="appointmentDataForm"  method="POST" action="<?php echo e(route('update.appointment')); ?>">
      <?php echo csrf_field(); ?>
      <!-- Group -->
...
<div   class="grid md:grid-cols-2 md:gap-6">
  ...
  <?php endif; ?><!--[if ENDBLOCK]><![endif]--><?php /**PATH C:\Project\A A FOR DEBUGGING AND TEST\app-depedsys\resources\views/forms/edit-appointment.blade.php ENDPATH**/ ?>